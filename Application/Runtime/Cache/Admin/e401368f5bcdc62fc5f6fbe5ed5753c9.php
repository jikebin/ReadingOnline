...
<div class="container body-top">
	...
	<!-- ---------------------------下面是中间部分------------------------ -->
		<div class="left-block pull-left">
			...
			<!-- -搜索框 -->
			<div>
				<form action="/index.php/Admin/User/writer" method="post" class="navbar-form ">
		        <div class="form-group" >
		        	<select class="form-control" name="kind">
		        		<option value="pen_name">昵称</option>
		        		<option value="phone">手机号</option>
		        		<option value="e_mail">邮箱</option>
		        	</select>
		          <input type="text" name="info" class="form-control" placeholder="查找用户">
		        </div>
			...
			<table class="table  table-hover table-bordered table-striped">
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a href="/index.php/Admin/User/writerData/WID/<?php echo ($vol["wid"]); ?>" class="btn btn-primary">详情信息</a>
						<a href="/index.php/Admin/User/initWirter/WID/<?php echo ($vol["wid"]); ?>" class="btn btn-danger">重置密码</a>
