...
<div class="container body-top">
		...
		<div class="my-list pull-left">
			<div class="list-group">
				<a class="list-group-item active" href="/index.php/Admin/AdminUpload/adminUpload"><span class="glyphicon glyphicon-folder-open">&nbsp;</span>图书上传</a>
	...
	<!-- ---------------------------下面是中间部分------------------------ -->
		<div class="left-block pull-left">
			...
			<div class="content">
			<form action="/index.php/Admin/AdminUpload/adminUpload" method="post" enctype="multipart/form-data">
				<div class="form-group">
				<label>上传图书</label>
				<input class="form-control" name="book" type="file" accept="text/plain">
				</div>
				<div class="form-group">
				<label>上传封面</label>
				...
				<div class="form-group">
				<label>作者</label>
				<input class="form-control" name="pen_name" type="text">
				</div>
				<div class="form-group">
				<label>图书简介</label>
				<textarea rows="4" cols="" placeholder="utf-8格式" class="form-control" name="intro"></textarea>
				</div>
				<input class="btn btn-primary" type="submit" value="上传图书">
			</form>
			</div>
		</div>
