	...
	<!-- ---------------------------下面是中间部分------------------------ -->
		<div class="left-block pull-left">
			...
			<div>
				...
				<tr>
					<td>头像：</td>
					<td><img alt="" src="<?php echo ($reader["img"]); ?>" class="img-circle"></td>
				</tr>
				<tr>
					<td>昵称：</td>
					<td><?php echo ($reader["nickname"]); ?></td>
				</tr>
				<tr>
					<td>书友ID:</td>
					<td><?php echo ($reader["rid"]); ?></td>
				</tr>
				<tr>
					<td>性别：</td>
					<td><?php echo ($reader["sex"]); ?></td>
				</tr>
				<tr>
					<td>真实姓名：</td>
				...
				<tr>
					<td>电子邮箱：</td>
					<td><?php echo ($reader["e_mail"]); ?></td>
				</tr>
				<tr>
					<td>QQ</td>
					<td><?php echo ($reader["qq"]); ?></td>
				</tr>
				<tr>
					<td>所在地区：</td>
				...
				<tr>
					<td colspan="2"><a href="/index.php/Home/Reader/readerDataAlter" class="btn btn-primary">修改</a></td>
				</tr>
			</table>
			</div>
		</div>
