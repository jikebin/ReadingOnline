...
<div class="container body-top">
		...
		<div class="my-list pull-left">
			<div class="list-group">
				...
				<a class="list-group-item active" href="/index.php/Home/Reader/reader"><span class="glyphicon glyphicon-book">&nbsp;</span>我的书架</a>
		...
		<div class="left-block pull-left">
			...
			<div class="row">
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="col-md-2">
						<a href="/index.php/Home/Index/bookShow/BID/<?php echo ($vol["bid"]); ?>"><img alt="" src="<?php echo ($vol["bookimg"]); ?>" class="img-rounded center-block"></a>
